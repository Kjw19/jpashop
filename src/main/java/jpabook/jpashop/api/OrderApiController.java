...
public class OrderApiController {
    ...
    @GetMapping("/api/v3/orders") //페이징 불가능!333334
    ...
    @GetMapping("/api/v3.1/orders") //페이징 가능
    ...
    public List<OrderQueryDto> ordersV6() {
        ...
        return flats.stream().collect(groupingBy(o -> new OrderQueryDto(o.getOrderId(), o.getName(), o.getOrderDate(),
